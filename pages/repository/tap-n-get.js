...
`;
  ...
  return (
      <>
       <Head>
            <title>Tap-n-Get | Sam Capuchino</title>
      ...
      <div className={styles.repositoryContainer}>
         <CleanHeader/>
           <div className={styles.repositoryMasthead}>
              <Image src="/projects/tapnget.png" alt="TapNGet" width={300} height={300} style={{borderRadius:"5px"}} />
            </div>
          ...
          <div className={styles.repositoryFooter}>
                <p className={styles.repositoryLabel}>sam capuchino | tapnget</p>
          </div>
      </div>
      </>
  );
