...
`;
  ...
  <>
       <Head>
            <title>Otalku | Sam Capuchino</title>
      ...
      <div className={styles.repositoryContainer}>
         <CleanHeader/>
           <div className={styles.repositoryMasthead}>
              <Image src="/projects/otalku.png" alt="Otalku" width={300} height={300} style={{borderRadius:"5px"}} />
            </div>
          ...
          <div className={styles.repositoryFooter}>
                <p className={styles.repositoryLabel}>sam capuchino | otalku</p>
          </div>
      </div>
  </>
  );
